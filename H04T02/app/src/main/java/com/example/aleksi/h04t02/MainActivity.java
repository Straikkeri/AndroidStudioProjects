package com.example.aleksi.h04t02;
...
public class MainActivity extends AppCompatActivity {
    ...
    private List<String> songs = new ArrayList<String>(); // string lista biisien nimille
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //lisätään listviewille onlcick kuuntelija, ja määritellään sille mediaplayerin alustus ja starttikomennot try catchin sisään(?) mikä on adapterview?
    ...
    private class LoadSongsTask extends AsyncTask<Void, String, Void> {
        ...
        //Edelleen taustathreadi //kutsuu itseään for-loopissa?
